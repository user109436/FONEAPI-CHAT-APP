/*
This controller can be used as a middleware to upload single image
like avatar or single chat image
...
exports.formatUserPhoto = catchAsync(async (req, res, next) => {
  ...
  await sharp(req.file.buffer).toFormat("jpeg").jpeg({ quality: 80 });
